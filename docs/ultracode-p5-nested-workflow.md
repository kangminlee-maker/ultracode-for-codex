...
**Concurrent nesting** (the sequential-only limit) SHIPPED in v2-B
(`docs/ultracode-p12-concurrent-nesting.md`, per-execution projector scope). Built-in workflows do not
